...
const responsiveWidth = (size: number) => (shortDimension / STANDARD_WINDOW.width) * size
const responsiveHeight = (size: number) => (longDimension / STANDARD_WINDOW.height) * size
