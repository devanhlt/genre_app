...
export interface HeaderProps {
   ...
   */
  title?: TypographyProps["text"]
  /**
   * Title text which is looked up via i18n.
   */
  titleTx?: TypographyProps["tx"]
  /**
   * Optional options to pass to i18n. Useful for interpolation
   * as well as explicitly setting locale or translation fallbacks.
   */
  titleTxOptions?: TypographyProps["txOptions"]
  /**
   ...
   */
  leftText?: TypographyProps["text"]
  /**
   * Left action text text which is looked up via i18n.
   * Can be used with `onLeftPress`. Overrides `leftIcon`.
   */
  leftTx?: TypographyProps["tx"]
  /**
   ...
   * as well as explicitly setting locale or translation fallbacks.
   */
  leftTxOptions?: TypographyProps["txOptions"]
  /**
   ...
   * as well as explicitly setting locale or translation fallbacks.
   */
  rightTxOptions?: TypographyProps["txOptions"]
  /**
      ...
      <View style={[$wrapper, $styleOverride]}>
        ...
        {!!titleContent && (
          <View
            ...
            pointerEvents="none"
          >
            <Typography text={titleContent} style={[$title, $titleStyleOverride]} />
          </View>
        )}
