  ...
  return (
    <View style={$containerStyles}>
      <TouchableOpacity {...TouchableOpacityProps} style={$touchableStyles}>
        ...
        <Typography {...TextProps} tx={tx} text={text} txOptions={txOptions} style={$textStyles}>
          {children}
        </Typography>
...
function ListItemAction(props: ListItemActionProps): JSX.Element {
...
const $separatorBottom: ViewStyle = {
  borderBottomWidth: 1,
  borderBottomColor: appColors.common.borderDefault,
}
